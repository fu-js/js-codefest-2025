			...
			<ul className="timeline timeline-snap-icon max-lg:timeline-compact timeline-vertical z-[2]">
				<li>
					...
					>
						...
						<ul className="pl-5 mt-8 space-y-3 list-disc marker:text-success hidden lg:block md:text-l leading-[2rem] font-sans">
							<li>
				...
				<li>
					...
					>
						...
						<ul className="pl-5 mt-8 space-y-3 list-disc marker:text-success hidden lg:block text-xl leading-[1.75rem] font-sans">
							<li>
				...
				<li>
					...
					<div className="timeline-end ml-6 text-xl" style={{ lineHeight: 2 }}>
						...
						<p className="pl-5 mt-8 space-y-3 list-disc marker:text-success font-sans hidden lg:block leading-[1.75rem]">
							<li>
